...
class torrent_tracker():
    ...
    def __str__(self):
        ...
        # Initialize variables to store tracker URLs and counts
        ...
        # Add row for not attempted connection(s)
